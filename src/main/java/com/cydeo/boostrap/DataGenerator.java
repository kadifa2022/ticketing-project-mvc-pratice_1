...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(ProjectService projectService, RoleService roleService, UserService userService, TaskService taskService) {
    ...
    @Override
    public void run(String... args) throws Exception {//Spring is providing for us interface and method//methode execute RUN methode first

        RoleDTO adminRole=new RoleDTO(1L,"Admin");//created objects
